  ...
  return (
    <div className="min-h-screen pt-28 relative overflow-hidden">
      ...
      <section className="py-24 glass-section border-t border-white/[0.04] relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeLeft} transition={{ duration: 0.7 }}>
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="flex flex-col gap-6 mb-8">
                {[
                  ...
                  return (
                    <motion.div key={i} variants={fadeUp} transition={{ duration: 0.4 }} className="flex items-center">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3, duration: 0.6 }} className="glass-card p-6 rounded-2xl animate-shimmer">
                <h3 className="text-xl font-bold mb-4 font-outfit text-zinc-100">What Happens Next?</h3>
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="flex flex-col gap-3 text-zinc-300 font-light">
                  {['We analyze your bottleneck within 24 hours', 'You get a custom action plan (not a generic proposal)', "If it's a fit, we deploy your solution within 48 hours"].map((step, i) => (
                    <motion.div key={i} variants={fadeUp} transition={{ duration: 0.3 }} className="flex items-start">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeRight} transition={{ duration: 0.7, delay: 0.15 }}>
              <h2 className="text-4xl font-bold mb-8 font-outfit">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="flex flex-col gap-8">
                {[
                  ...
                  <motion.div key={i} variants={fadeUp} transition={{ duration: 0.5 }} className={`border-l-4 ${item.color} pl-6`}>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4, duration: 0.6 }} className="mt-8 glass-card p-6 rounded-2xl animate-shimmer">
      ...
      <section className="py-24 border-t border-white/[0.04] relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ duration: 0.6 }} className="text-4xl font-bold mb-12 text-center font-outfit">Prefer a Different Approach?</motion.h2>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={stagger} className="grid md:grid-cols-3 gap-8">
            <motion.div variants={scaleIn} transition={{ duration: 0.5 }} whileHover={{ y: -4 }} className="group glass-card p-8 rounded-2xl md:col-span-2 flex flex-col justify-between animate-shimmer">
              <div>
            ...
            <motion.div variants={scaleIn} transition={{ duration: 0.5 }} whileHover={{ y: -4 }} className="group glass-card p-8 rounded-2xl md:col-span-1 flex flex-col justify-between animate-shimmer">
              <div>
